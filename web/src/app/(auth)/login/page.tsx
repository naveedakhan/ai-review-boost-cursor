...
import { signInAction, googleSignInAction } from "@/lib/auth";
      ...
      <div className="grid w-full gap-8 rounded-3xl border border-slate-200 bg-white p-8 shadow-soft md:grid-cols-2">
        <div className="space-y-4">
          ...
          <p className="text-sm text-slate-600">
            Built for restaurant teams in Pakistan. Continue with your email or Google.
          </p>
          <div className="rounded-2xl bg-slate-50 p-4 text-sm text-slate-700">
            Use the same account for your restaurant and admin access if you have it.
          </div>
        </div>
